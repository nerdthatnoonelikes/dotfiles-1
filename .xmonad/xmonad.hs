...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- Start Chrome
	, ((modm .|. shiftMask, xK_f     ), spawn "google-chrome-stable --disable-features=GlobalMediaControls")
	...
	, ((modm .|. shiftMask, xK_b     ), spawn "weather")
...
myStartupHook = do
              ...
              spawn "/home/tempora/.config/polybar/polybar.sh"
